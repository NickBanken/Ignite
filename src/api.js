...
const key = process.env.REACT_APP_GAMES;
...
const new_games = `games?key=${key}&dates=${lastYear},${currentDate}&odering=-released&page_size=10`;
...
export const searchGameURL = (game_name) =>
  `${base_url}games?key=${key}&search=${game_name}&page_size=15`;
